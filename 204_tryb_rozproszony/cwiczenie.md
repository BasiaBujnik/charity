...
3. Wykorzystaj polecenia z Dockefile'a. który wczeœniej stworzyliœmy aby na ka¿dej maszynie zainstalowaæ JMetera
...
Polecenia do wklejenie w konsoli Bastiona:
          ...
          #pusc test gdzie worker ip to np.  10.0.0.5
          cd apache-jmeter-5.4.1/bin
